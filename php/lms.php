...
<body>
    ...
    <div>
        ...
        <div>
        <img src="Images/Blank_icon.png" width="100%" height="20" style="vertical-align:middle">
        <img class="pdbtn" src="Images/NavBarBg.png" width="100%" height="5">
      </div>
        ...
        &nbsp;&nbsp;&nbsp;No of Leads: &nbsp;
        <select name="ddlList" id="ddlList">
	...
	<option value="4">ALL</option>
        ...
        <input type="image" name="btnExcel" id="btnExcel" class="btnSubmit" Text="" src="Images/Download_Btn.png" />
