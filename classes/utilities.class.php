...
class Utilities {
	function __construct($pdo)
        ...
        function exportToExcel(){
            $XML = "contactID,contactName,contactEmail,contactMobile,contactRegion,createdDate\n";
            $file ="report_". date("Y-m-d"). ".csv";
            $query = $this->pdo->prepare("SELECT * FROM contact ORDER by contactID ASC");
            $query->execute();
            ...
            if($count>0){
                        ...
                        $XML.= $myrow['contactID']. ",";
                        $XML.= $myrow['contactName']. ",";
                        $XML.= $myrow['contactEmail']. ",";
                        $XML.= $myrow['contactMobile']. ",";
                        $XML.= $myrow['contactRegion']. ",";
                        $XML.= $myrow['createdDate']. "\n";   
                        }
            }
        ...
        function sendmail($to,$subject,$body=null,$from)
	{
